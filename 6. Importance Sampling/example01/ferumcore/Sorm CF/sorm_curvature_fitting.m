...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   hess_G = hessian_G(lsf,dsptx,dsptu,G,probdata,gfundata,femodel,randomfield);
...
pf2_breitung = real(pf2_breitung);
...
% pf2_breitung_mod = real(pf2_breitung_mod);
